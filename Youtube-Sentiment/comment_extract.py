...
key = 'AIzaSyCn5ZYUXMSO4aSOt2DgABsAiPgYPasg8-4'
...
def commentExtract(videoId, count = -1):
	...
	for i in range(len(page_info['items'])):
		comments.append(page_info['items'][i]['snippet']['topLevelComment']['snippet']['authorDisplayName'])
		comments[i]+=":"+(page_info['items'][i]['snippet']['topLevelComment']['snippet']['textOriginal'])
		co += 1
		if co == count:
